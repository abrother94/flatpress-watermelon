...
smarty_core_load_plugins(array('plugins' => array(array('block', 'widgets', 'sidebar.tpl', 1, false),)), $this); ?>
	<div class="navigation">		<?php $this->_tag_stack[] = array('widgets', array('pos' => 'top')); $_block_repeat=true;smarty_block_widgets($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>		<div id="<?php echo $this->_tpl_vars['id']; ?>
...
		</div>		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_widgets($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>		<?php $this->_tag_stack[] = array('widgets', array('pos' => 'bottom')); $_block_repeat=true;smarty_block_widgets($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>		<div id="<?php echo $this->_tpl_vars['id']; ?>
"><h1><?php echo $this->_tpl_vars['subject']; ?>
</h1>		<?php echo $this->_tpl_vars['content']; ?>
