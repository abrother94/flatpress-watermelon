<?php /* Smarty version 2.6.30, created on 2019-01-23 12:14:33
...
smarty_core_load_plugins(array('plugins' => array(array('block', 'entry', 'preview.tpl', 1, false),array('modifier', 'tag', 'preview.tpl', 3, false),array('modifier', 'date_format', 'preview.tpl', 4, false),)), $this); ?>
 ...
 on <?php echo ((is_array($_tmp=$this->_tpl_vars['date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%A, %B %e, %Y - %H:%M:%S") : theme_date_format($_tmp, "%A, %B %e, %Y - %H:%M:%S")); ?>
 </p>
